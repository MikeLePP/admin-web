...
const CustomerDataManagement: FC = (props) => (
  <Card {...props}>
    <CardHeader title="Data Management [Not Available]" />
    <Divider />
    <CardContent>
      <Box
        sx={{
      ...
      >
        <Button color="inherit" startIcon={<BanIcon fontSize="small" />} variant="text">
          Close Account
        </Button>
        <Button color="inherit" startIcon={<DownloadIcon fontSize="small" />} sx={{ mt: 1 }} variant="text">
          Export Data
        </Button>
      </Box>
      <Box
