      ...
      <Page size="A4" style={styles.page}>
        <View style={styles.header}>
          ...
          <View>
            ...
            <Text style={styles.subtitle2}>Invoice # 3593865</Text>
          </View>
        </View>
        ...
        <View style={styles.references}>
          <View>
            ...
            <Text style={styles.body2}>{format(invoice.dueDate, 'dd MMM yyyy')}</Text>
          </View>
          <View>
            <Text style={[styles.subtitle2, styles.gutterBottom]}>Date of issue</Text>
            <Text style={styles.body2}>{format(invoice.issueDate, 'dd MMM yyyy')}</Text>
          </View>
          <View>
