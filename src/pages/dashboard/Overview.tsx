        ...
        <Container maxWidth={settings.compact ? 'xl' : false}>
          <Grid container spacing={3}>
            <Grid alignItems="center" container justifyContent="space-between" spacing={3} item xs={12}>
              ...
              <Grid item>
                <Button color="primary" startIcon={<PlusIcon fontSize="small" />} variant="contained">
                  New Transaction
                </Button>
              </Grid>
            </Grid>
            ...
            <Grid item md={6} xs={12}>
              <Card>
                ...
                >
                  <Button color="primary" endIcon={<ExternalLinkIcon fontSize="small" />} variant="text">
                    Help Center
                  </Button>
                </CardActions>
              </Card>
            ...
            <Grid item md={6} xs={12}>
              <Card>
                ...
                >
                  <Button color="primary" endIcon={<DownloadIcon fontSize="small" />} variant="outlined">
                    Download Free PDF
                  </Button>
                </CardActions>
              </Card>
            ...
            <Grid item md={6} xs={12}>
              <Card>
                ...
                >
                  <Button color="primary" endIcon={<ArrowRightIcon fontSize="small" />} variant="outlined">
                    My Contacts
                  </Button>
                </CardActions>
              </Card>
